...
.新功能與支援
* link:../get-started/setup_overview.html#add-a-storage-backend["Astra Control Center的Astra Data Store部署"]
* link:../concepts/user-roles-namespaces.html["命名空間角色型存取控制（RBAC）"]
* link:../get-started/install_acc-cvo.html["支援Cloud Volumes ONTAP 功能"]
