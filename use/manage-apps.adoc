...
TIP: 標籤是可指派給Kubernetes物件以供識別的金鑰/值配對。標籤可讓您更輕鬆地排序、組織及尋找Kubernetes物件。若要深入瞭解Kubernetes標籤、 https://["請參閱Kubernetes官方文件"^]。
...
TIP: 若要深入瞭解Kubernetes標籤、 https://["請參閱Kubernetes官方文件"^]。
